...
const STRINGS = {
  en: {
    ...
    'ab.p1': 'Since 1996 Torah MiTzion has sent shlichim — young men and women, families, Roshei Kollel — to Jewish communities around the world, to learn and teach Torah and to live alongside the community for a year or several. This archive is the thirtieth-anniversary attempt to gather the photographs of all of it.',
  ...
  he: {
    ...
    'ab.p1': 'מאז 1996 תורה מציון שולחת שליחים — בחורים ובחורות, משפחות, ראשי כוללים — לקהילות יהודיות ברחבי העולם, ללמוד וללמד תורה ולחיות לצד הקהילה שנה או כמה שנים. הארכיון הזה הוא הניסיון, לרגל שלושים שנה, לאסוף את התמונות של כל זה.',
  ...
  ru: {
    ...
    'ab.p1': 'С 1996 года Тора ми-Цион посылает шлихим — юношей и девушек, семьи, рошей колель — в еврейские общины по всему миру, чтобы учить Тору и учить ей и жить рядом с общиной год или несколько. Этот архив — попытка к тридцатилетию собрать фотографии всего этого.',
  ...
  de: {
    ...
    'ab.p1': 'Seit 1996 entsendet Torah MiTzion Schlichim – junge Männer und Frauen, Familien, Rosche Kollel – in jüdische Gemeinden weltweit, um Tora zu lernen und zu lehren und ein Jahr oder mehrere an der Seite der Gemeinde zu leben. Dieses Archiv ist der Versuch zum dreißigsten Jubiläum, die Fotos von all dem zu sammeln.',
  ...
  es: {
    ...
    'ab.p1': 'Desde 1996 Torah MiTzion envía shlijim —jóvenes, familias, Roshei Kolel— a comunidades judías de todo el mundo, para estudiar y enseñar Torá y vivir junto a la comunidad uno o varios años. Este archivo es el intento, por el trigésimo aniversario, de reunir las fotografías de todo ello.',
