...
const STRINGS = {
  ...
  he: {
    ...
    'chat.all': 'כל השנים',
    'foot.source': 'שמות, שנים וקהילות נלקחו מהאתר של תורה מציון. איסוף התמונות עדיין נמשך.',
    'u.loading': 'טוען…',
  ...
  ru: {
    ...
    'chat.all': 'Все годы',
    'foot.source': 'Имена, годы и общины взяты с сайта torahmitzion.org. Сбор фотографий продолжается.',
    'u.loading': 'Загрузка…',
  ...
  fr: {
    ...
    'foot.source': 'Noms, années et communautés repris de torahmitzion.org. La collecte des photographies se poursuit.',
  ...
  de: {
    ...
    'chat.all': 'Alle Jahre',
    'foot.source': 'Namen, Jahre und Gemeinden stammen von torahmitzion.org. Die Fotos werden noch gesammelt.',
  ...
  es: {
    ...
    'foot.source': 'Nombres, años y comunidades tomados de torahmitzion.org. La recolección de fotografías continúa.',
    'u.loading': 'Cargando…',
