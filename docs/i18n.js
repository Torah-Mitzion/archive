...
const STRINGS = {
  ...
  he: {
    ...
    'ab.p1': 'מאז 1996 תורה מציון שולחת שליחים — בחורים ובחורות, משפחות, ראשי כוללים — לקהילות יהודיות ברחבי העולם, ללמוד וללמד תורה ולחיות לצד הקהילה שנה או כמה שנים. האלבום הזה הוא הניסיון, לרגל שלושים שנה, לאסוף את התמונות של כל זה.',
    'ab.p2': 'המפה מחזיקה כל קהילה שאי פעם היה בה כולל, וכל שנה שלה. השמות מגיעים מהרישומים של הארגון. התמונות מגיעות מכם: קופסת נעליים, טלפון, קיר של בית כנסת. שלחו אחת בוואטסאפ או מהאתר; עוזר בודק אותה, שואל איפה ומתי צולמה, ומניח אותה בעמוד הנכון.',
    'ab.p3': 'אם שירתתם, או אירחתם, או פשוט הייתם שם — חפשו את השנה שלכם. אם היא ריקה, אתם יודעים מה לעשות.',
